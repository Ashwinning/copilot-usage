...
export function resolveCopilotUsageRoot(explicitPath) {
    if (explicitPath) {
        return explicitPath;
    }
...
export function resolvePaths(explicitPath) {
...
export async function ensurePaths(paths) {
...
export async function loadUsageState(paths) {
    try {
        ...
        if (reposValue && typeof reposValue === "object") {
            for (const [repoPath, entry] of Object.entries(reposValue)) {
                ...
                repos[repoPath] = {
                    ...
                    updatedAt: typeof entryRecord.updatedAt === "string"
...
export async function saveUsageState(paths, state) {
